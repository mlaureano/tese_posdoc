...
\TipoDeDocumento{Tese}%% Tipo de documento: "Tese", "Dissertação" ou "Trabalho de Conclusão de Curso de Graduação", "Estágio Supervisionado"
\NivelDeFormacao{Doutorado}%% Nível de formação: "Doutorado", "Mestrado", "Bacharelado" ou "Tecnólogo" - ATENÇÃO, isso será utilizado para alterar a formatação do trabalho, pois pode haver formatações distintas dependendo o nível/tipo de trabalho.
...
% <<<<<<< Updated upstream
\program{Engenharia Elétrica e Informática Industrial}
\programen{Graduate Program in Electrical and Computer Engineering}
\degree{Doutor em Ciências}
\degreearea{Programa de Pós-Graduação em Engenharia Elétrica e Informática Industrial}
%=======
\program{Programa de Pós-Graduação em Engenharia Elétrica e Informática Industrial}
%\programen{Undergradute Program in Computer Science}
\degree{Doutor em Ciências}
\degreearea{área de concentração Engenharia de Automação e Sistemas}
%>>>>>>> Stashed changes
% Caso seja TSI:
...
% TCC2:
%<<<<<<< Updated upstream
 \goal{Projeto de pós-doutorado}
%=======
 \goal{Projeto de pós-doutorado}
%>>>>>>> Stashed changes
 \course{Projeto de pós-doutorado}


% Dados do TCC (precisa alterar) 
%<<<<<<< Updated upstream
%\author{Márlon de Oliveira Vaz}  % Seu nome
%\authorbib{Vaz, Márlon de O.} % Seu nome para referência bibliográfica (Sobrenome, Nome)
%\title{IDSet - Criação de um Conjunto de Imagens de Objetos Residencias para a Detecção e Reconhecimento aplicada a RoboCup@Home Brasil} % Título do trabalho
%\titleen{IDSet - Creation of a Dataset of Residential Object Images for Detection and Recognition Applied to RoboCup@Home Brazil.} % Título traduzido para inglês
%\advisor{André Schneider de Oliveira, Prof. Dr.} % Nome do orientador. Lembre-se de prefixar com "Prof. Dr.", "Profª. Drª.", "Prof. Me." ou "Profª. Me."}
%% Se não houver corientador, comente a linha a baixo
%\coadvisor{João Alberto Fabro, Prof. Dr.} % Nome do coorientador, caso exista. Caso não exista, comente a linha.
%\depositshortdate{2023} % Ano em que depositou este documento
%%\approvaldate{01/janeiro/2021}
%=======
\author{MARCOS AURELIO PCHEK LAUREANO}  % Seu nome
\authorbib{LAUREANO, MARCOS AURELIO PCHEK} % Seu nome para referência bibliográfica (Sobrenome, Nome)<<<<<<< HEAD
\title{Aplicação de Braços Robóticos para Inspirar Jovens na Pesquisa Robótica: Uso em Ambientes Educacionais Informais} % Título do trabalho
\titleen{} % Título traduzido para inglês
%\titleen{IDSet - Creation of a Image Dataset of Residential Object for Detection and Recognition in the Context of RoboCup@Home Brazil} % 
\advisor{Prof. Dr. André Schneider de Oliveira} % Nome do orientador. Lembre-se de prefixar com "Prof. Dr.", "Profª. Drª.", "Prof. Me." ou "Profª. Me."}
% Se não houver corientador, comente a linha a baixo
%\coadvisor{Prof. Dr. João Alberto Fabro} % Nome do coorientador, caso exista. Caso não exista, comente a linha.
%\depositshortdate{2024} % Ano em que depositou este documento
%\approvaldate{19/janeiro/2024}
%>>>>>>> Stashed changes

% Dados do curso que não precisam de alteração
\university{Universidade Tecnológica Federal do Paraná}
\universityen{Federal University of Technology of Paraná}
\universitycampus{Campus Curitiba}
\universityunit{Programa de Pós-Graduação em Engenharia Elétrica e Informática Industrial}
%<<<<<<< Updated upstream
\address{Curitiba}
...
\PalavraChaveA{braço robótico}%% Palavra-chave A
\PalavraChaveB{STEAM}%% Palavra-chave B
%\PalavraChaveC{}%% Palavra-chave C
%\PalavraChaveD{Algoritmos para manipula\c{c}\~{a}o de imagens}%% Palavra-chave D
%\PalavraChaveE{Detec\c{c}\~{a}o e reconhecimento de objetos}%% Palavra-chave E
...
\KeywordA{Image Dataset}%% Keyword A
\KeywordB{Computer Vision}%% Keyword B
\KeywordC{Convolutional Neural Networks}%% Keyword C
\KeywordD{Algorithms for Image Manipulation}%% Keyword D
\KeywordE{Detection and Recognition of Objects}%% Keyword E
